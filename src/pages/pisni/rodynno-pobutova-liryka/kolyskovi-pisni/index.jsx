...
const KolyskoviPisniPage = ({ pageContext }) => {
  ...
  return (
    <>
      ...
      <div className="container-lg py-10 md:py-24">
        <h2 className="typo-h2">
          Опис жанру - колискова пісня
        </h2>
        <p className="typo-body mt-4">
          Колискові пісні виділені в окремий цикл родинно-побутових пісень, так як мають індивідуальну особливість та
          призначення. Виконання колискової здійснуються лише однією людиною – матір'ю або дуже близькою особою та лише
          для однієї людини — немовляти.
        </p>
        <p className="typo-body mt-4">
          ...
          з мамою, залишає вічний відбиток у приймаючих чуйні колискові. Всю ласкавість, чуттєвість, кохання, жадання
          ...
          спілкуванням за порядком та добротою до інших.
        </p>
      </div>
    </>
  );
