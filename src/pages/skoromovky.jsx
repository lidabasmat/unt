...
const SkoromovkyPage = ({ pageContext }) => {
  return (
    <>
      <Seo
        title="Скоромовки"
        description="Скоромовка, швидкомовка або чистомовка — жанр як фольклорного, так і літературного походження: дотепна гра спеціально скомпонованих важковимовних слів, і звуків, що створюють труднощі для швидкої й виразної вимови слів."
      />
